/*
 * Copyright (C) 2020 Shweta Porwal
 *
...
class ToolbarUtil private constructor() {
    ...
    companion object {
         ...
         *
         * @version 1.0.1 by Shweta Porwal : Fixed issue for [NullPointerException] when removing view from [Toolbar]
         */
        @JvmStatic
